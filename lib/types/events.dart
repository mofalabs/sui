...
class MoveEvent {
  ...
  MoveEvent(this.packageId, this.transactionModule, this.sender, this.type,
      this.fields, this.bcs);
}
...
class TransferObjectEvent {
  ...
  TransferObjectEvent(this.packageId, this.transactionModule, this.sender,
...
class DeleteObjectEvent {
  ...
  DeleteObjectEvent(this.packageId, this.transactionModule, this.sender,
      this.objectId, this.version);
}
