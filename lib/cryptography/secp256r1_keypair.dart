...
class Secp256r1Keypair with Keypair {
  ...
  Secp256r1Keypair([Secp256KeypairData? keypair]) {
    if (keypair != null) {
      ...
      Uint8List publicKey =
          secp256r1.getPublicKeyFromPrivateKeyBytes(secretKey);
  ...
  static Secp256r1Keypair fromSecretKey(Uint8List secretKey,
      {bool? skipValidation}) {
    Uint8List publicKey =
        secp256r1.getPublicKeyFromPrivateKeyBytes(secretKey, false);
