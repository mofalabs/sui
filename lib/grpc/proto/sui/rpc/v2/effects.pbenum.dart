...
class ChangedObject_OutputObjectState extends $pb.ProtobufEnum {
  ...
  static const ChangedObject_OutputObjectState
      OUTPUT_OBJECT_STATE_ACCUMULATOR_WRITE = ChangedObject_OutputObjectState._(
          4, _omitEnumNames ? '' : 'OUTPUT_OBJECT_STATE_ACCUMULATOR_WRITE');
...
class AccumulatorWrite_AccumulatorOperation extends $pb.ProtobufEnum {
  static const AccumulatorWrite_AccumulatorOperation
      ACCUMULATOR_OPERATION_UNKNOWN = AccumulatorWrite_AccumulatorOperation._(
          0, _omitEnumNames ? '' : 'ACCUMULATOR_OPERATION_UNKNOWN');
  static const AccumulatorWrite_AccumulatorOperation MERGE =
      AccumulatorWrite_AccumulatorOperation._(1, _omitEnumNames ? '' : 'MERGE');
  static const AccumulatorWrite_AccumulatorOperation SPLIT =
      AccumulatorWrite_AccumulatorOperation._(2, _omitEnumNames ? '' : 'SPLIT');

  static const $core.List<AccumulatorWrite_AccumulatorOperation> values =
  ...
  static final $core.List<AccumulatorWrite_AccumulatorOperation?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 2);
  static AccumulatorWrite_AccumulatorOperation? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
