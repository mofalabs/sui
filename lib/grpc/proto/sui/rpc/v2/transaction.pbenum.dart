...
class TransactionExpiration_TransactionExpirationKind extends $pb.ProtobufEnum {
  ...
  static const TransactionExpiration_TransactionExpirationKind VALID_DURING =
      TransactionExpiration_TransactionExpirationKind._(
...
class TransactionKind_Kind extends $pb.ProtobufEnum {
  static const TransactionKind_Kind KIND_UNKNOWN =
      TransactionKind_Kind._(0, _omitEnumNames ? '' : 'KIND_UNKNOWN');

  /// A user transaction comprised of a list of native commands and Move calls.
  static const TransactionKind_Kind PROGRAMMABLE_TRANSACTION =
      TransactionKind_Kind._(
          1, _omitEnumNames ? '' : 'PROGRAMMABLE_TRANSACTION');
  ...
  static const TransactionKind_Kind CHANGE_EPOCH =
      TransactionKind_Kind._(2, _omitEnumNames ? '' : 'CHANGE_EPOCH');

  /// Transaction used to initialize the chain state.
  ///
  /// Only valid if in the genesis checkpoint (0) and if this is the very first transaction ever
  /// executed on the chain.
  static const TransactionKind_Kind GENESIS =
      TransactionKind_Kind._(3, _omitEnumNames ? '' : 'GENESIS');

  /// V1 consensus commit update.
  static const TransactionKind_Kind CONSENSUS_COMMIT_PROLOGUE_V1 =
      TransactionKind_Kind._(
          4, _omitEnumNames ? '' : 'CONSENSUS_COMMIT_PROLOGUE_V1');

  /// Update set of valid JWKs used for zklogin.
  static const TransactionKind_Kind AUTHENTICATOR_STATE_UPDATE =
      TransactionKind_Kind._(
          5, _omitEnumNames ? '' : 'AUTHENTICATOR_STATE_UPDATE');

  /// Set of operations to run at the end of the epoch to close out the current epoch and start
  /// the next one.
  static const TransactionKind_Kind END_OF_EPOCH =
      TransactionKind_Kind._(6, _omitEnumNames ? '' : 'END_OF_EPOCH');

  /// Randomness update.
  static const TransactionKind_Kind RANDOMNESS_STATE_UPDATE =
      TransactionKind_Kind._(
          7, _omitEnumNames ? '' : 'RANDOMNESS_STATE_UPDATE');

  /// V2 consensus commit update.
  static const TransactionKind_Kind CONSENSUS_COMMIT_PROLOGUE_V2 =
      TransactionKind_Kind._(
          8, _omitEnumNames ? '' : 'CONSENSUS_COMMIT_PROLOGUE_V2');

  /// V3 consensus commit update.
  static const TransactionKind_Kind CONSENSUS_COMMIT_PROLOGUE_V3 =
      TransactionKind_Kind._(
          9, _omitEnumNames ? '' : 'CONSENSUS_COMMIT_PROLOGUE_V3');

  /// V4 consensus commit update.
  static const TransactionKind_Kind CONSENSUS_COMMIT_PROLOGUE_V4 =
      TransactionKind_Kind._(
          10, _omitEnumNames ? '' : 'CONSENSUS_COMMIT_PROLOGUE_V4');

  /// A system transaction comprised of a list of native commands and Move calls.
  static const TransactionKind_Kind PROGRAMMABLE_SYSTEM_TRANSACTION =
      TransactionKind_Kind._(
          11, _omitEnumNames ? '' : 'PROGRAMMABLE_SYSTEM_TRANSACTION');
  ...
  static final $core.List<TransactionKind_Kind?> _byValue =
      $pb.ProtobufEnum.$_initByValueList(values, 11);
  static TransactionKind_Kind? valueOf($core.int value) =>
      value < 0 || value >= _byValue.length ? null : _byValue[value];
...
class EndOfEpochTransactionKind_Kind extends $pb.ProtobufEnum {
  static const EndOfEpochTransactionKind_Kind KIND_UNKNOWN =
      EndOfEpochTransactionKind_Kind._(0, _omitEnumNames ? '' : 'KIND_UNKNOWN');

  /// End the epoch and start the next one.
  static const EndOfEpochTransactionKind_Kind CHANGE_EPOCH =
      EndOfEpochTransactionKind_Kind._(1, _omitEnumNames ? '' : 'CHANGE_EPOCH');

  /// Create and initialize the authenticator object used for zklogin.
  static const EndOfEpochTransactionKind_Kind AUTHENTICATOR_STATE_CREATE =
      EndOfEpochTransactionKind_Kind._(
          2, _omitEnumNames ? '' : 'AUTHENTICATOR_STATE_CREATE');

  /// Expire JWKs used for zklogin.
  static const EndOfEpochTransactionKind_Kind AUTHENTICATOR_STATE_EXPIRE =
      EndOfEpochTransactionKind_Kind._(
          3, _omitEnumNames ? '' : 'AUTHENTICATOR_STATE_EXPIRE');

  /// Create and initialize the randomness object.
  static const EndOfEpochTransactionKind_Kind RANDOMNESS_STATE_CREATE =
      EndOfEpochTransactionKind_Kind._(
          4, _omitEnumNames ? '' : 'RANDOMNESS_STATE_CREATE');

  /// Create and initialize the deny list object.
  static const EndOfEpochTransactionKind_Kind DENY_LIST_STATE_CREATE =
      EndOfEpochTransactionKind_Kind._(
          5, _omitEnumNames ? '' : 'DENY_LIST_STATE_CREATE');

  /// Create and initialize the bridge object.
  static const EndOfEpochTransactionKind_Kind BRIDGE_STATE_CREATE =
      EndOfEpochTransactionKind_Kind._(
          6, _omitEnumNames ? '' : 'BRIDGE_STATE_CREATE');

  /// Initialize the bridge committee.
  static const EndOfEpochTransactionKind_Kind BRIDGE_COMMITTEE_INIT =
      EndOfEpochTransactionKind_Kind._(
          7, _omitEnumNames ? '' : 'BRIDGE_COMMITTEE_INIT');

  /// Execution time observations from the committee to preserve cross epoch
  static const EndOfEpochTransactionKind_Kind
      STORE_EXECUTION_TIME_OBSERVATIONS = EndOfEpochTransactionKind_Kind._(
          8, _omitEnumNames ? '' : 'STORE_EXECUTION_TIME_OBSERVATIONS');

  /// Create the accumulator root object.
  static const EndOfEpochTransactionKind_Kind ACCUMULATOR_ROOT_CREATE =
      EndOfEpochTransactionKind_Kind._(
          9, _omitEnumNames ? '' : 'ACCUMULATOR_ROOT_CREATE');

  /// Create and initialize the Coin Registry object.
  static const EndOfEpochTransactionKind_Kind COIN_REGISTRY_CREATE =
      EndOfEpochTransactionKind_Kind._(
          10, _omitEnumNames ? '' : 'COIN_REGISTRY_CREATE');

  /// Create and initialize the Display Registry object.
  static const EndOfEpochTransactionKind_Kind DISPLAY_REGISTRY_CREATE =
      EndOfEpochTransactionKind_Kind._(
          11, _omitEnumNames ? '' : 'DISPLAY_REGISTRY_CREATE');

  /// Create and initialize the Address Alias State object.
  static const EndOfEpochTransactionKind_Kind ADDRESS_ALIAS_STATE_CREATE =
      EndOfEpochTransactionKind_Kind._(
          12, _omitEnumNames ? '' : 'ADDRESS_ALIAS_STATE_CREATE');

  /// Write the end-of-epoch-computed storage cost for accumulator objects.
  static const EndOfEpochTransactionKind_Kind WRITE_ACCUMULATOR_STORAGE_COST =
      EndOfEpochTransactionKind_Kind._(
