...
class GetObjectRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..a<$fixnum.Int64>(2, _omitFieldNames ? '' : 'version', $pb.PbFieldType.OU6,
        defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$1.FieldMask>(3, _omitFieldNames ? '' : 'readMask',
...
class GetObjectResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aOM<$2.Object>(1, _omitFieldNames ? '' : 'object',
...
class GetObjectResult extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..aOM<$2.Object>(1, _omitFieldNames ? '' : 'object',
        subBuilder: $2.Object.create)
    ..aOM<$3.Status>(2, _omitFieldNames ? '' : 'error',
...
class GetCheckpointResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aOM<$5.Checkpoint>(1, _omitFieldNames ? '' : 'checkpoint',
        subBuilder: $5.Checkpoint.create)
    ..hasRequiredFields = false;
...
class GetEpochResponse extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(_omitMessageNames ? '' : 'sui.rpc.v2'),
      createEmptyInstance: create)
    ..aOM<$6.Epoch>(1, _omitFieldNames ? '' : 'epoch',
        subBuilder: $6.Epoch.create)
    ..hasRequiredFields = false;
...
class LedgerServiceApi {
  ...
  $async.Future<GetServiceInfoResponse> getServiceInfo(
          $pb.ClientContext? ctx, GetServiceInfoRequest request) =>
      _client.invoke<GetServiceInfoResponse>(ctx, 'LedgerService',
          'GetServiceInfo', request, GetServiceInfoResponse());
  $async.Future<GetObjectResponse> getObject(
          $pb.ClientContext? ctx, GetObjectRequest request) =>
      _client.invoke<GetObjectResponse>(
          ctx, 'LedgerService', 'GetObject', request, GetObjectResponse());
  $async.Future<BatchGetObjectsResponse> batchGetObjects(
          $pb.ClientContext? ctx, BatchGetObjectsRequest request) =>
      _client.invoke<BatchGetObjectsResponse>(ctx, 'LedgerService',
          'BatchGetObjects', request, BatchGetObjectsResponse());
  $async.Future<GetTransactionResponse> getTransaction(
          $pb.ClientContext? ctx, GetTransactionRequest request) =>
      _client.invoke<GetTransactionResponse>(ctx, 'LedgerService',
          'GetTransaction', request, GetTransactionResponse());
  $async.Future<BatchGetTransactionsResponse> batchGetTransactions(
          $pb.ClientContext? ctx, BatchGetTransactionsRequest request) =>
      _client.invoke<BatchGetTransactionsResponse>(ctx, 'LedgerService',
          'BatchGetTransactions', request, BatchGetTransactionsResponse());
  $async.Future<GetCheckpointResponse> getCheckpoint(
          $pb.ClientContext? ctx, GetCheckpointRequest request) =>
      _client.invoke<GetCheckpointResponse>(ctx, 'LedgerService',
          'GetCheckpoint', request, GetCheckpointResponse());
  $async.Future<GetEpochResponse> getEpoch(
          $pb.ClientContext? ctx, GetEpochRequest request) =>
      _client.invoke<GetEpochResponse>(
          ctx, 'LedgerService', 'GetEpoch', request, GetEpochResponse());
}
