...
void main() {
  ...
  final INVALID_SECP256R1_PUBLIC_KEY =
  ...
  group('Secp256r1PublicKey', () {
    test('invalid', () {
      ...
      expect(() {
        ...
        Secp256PublicKey.fromString(
            invalidPubKeyBase64, SIGNATURE_SCHEME_TO_FLAG.Secp256r1);
      }, throwsArgumentError);

      expect(() {
        final wrongEncode = Hex.encode(VALID_SECP256R1_PUBLIC_KEY);
        Secp256PublicKey.fromString(
            wrongEncode, SIGNATURE_SCHEME_TO_FLAG.Secp256r1);
      }, throwsFormatException);

      expect(() {
        Secp256PublicKey.fromString(
            '12345', SIGNATURE_SCHEME_TO_FLAG.Secp256r1);
      }, throwsFormatException);
    });
    ...
    test('toBase64', () {
      ...
      final key = Secp256PublicKey.fromString(
          pubKeyBase64, SIGNATURE_SCHEME_TO_FLAG.Secp256r1);
    ...
    test('toBuffer', () {
      ...
      expect(
          Secp256PublicKey.fromBytes(
                  key.toRawBytes(), SIGNATURE_SCHEME_TO_FLAG.Secp256r1)
              .equals(key),
          true);
    });
    ...
    SECP_TEST_CASES.forEach((data) {
      ...
      test('toSuiAddress from base64 public key $suiAddress}', () {
        final key = Secp256PublicKey.fromString(
            rawPublicKey, SIGNATURE_SCHEME_TO_FLAG.Secp256r1);
