...
void main() {
  test('request sui faucet v0', () async {
    ...
    final resp = await faucet.requestSuiFromFaucetV0(
  ...
  test('request sui faucet v1', () async {
    final faucet = FaucetClient(SuiUrls.faucetDevAPI);
    final resp = await faucet.requestSuiFromFaucetV1(
        '0x374114b640af9825ad85bd174f28ea38ed217c0740b4e5f588e8535dfbbe92e0');
